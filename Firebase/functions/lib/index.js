...
const gmailEmail = mail_config_1.MailConfig.USERNAME;
const gmailPassword = mail_config_1.MailConfig.PASSWORD;
...
exports.sendEmailContact = functions.https.onRequest((request, response) => {
    ...
    return mailTransport.sendMail(mailOptions)
        .then(() => console.log(`New contact email sent from:`, request.email))
